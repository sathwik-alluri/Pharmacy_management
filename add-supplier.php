...
<input name="sname" value="" class="form-control" type="text" placeholder="Enter Name">
</div>
</div>
<div class="col-12 col-sm-4">
<div class="form-group local-forms">
<label>Licence Number <span class="login-danger">*</span></label>
<input name="licnum" value="" class="form-control" type="text" placeholder="Enter Licence Number">
</div>
</div>
<!--
<div class="col-12 col-sm-4">
...
<input name="place" value="" class="form-control" type="text" placeholder="Enter Place">
</div>
</div> 
